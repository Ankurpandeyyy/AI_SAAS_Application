  ...
  return (
    <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700'>
      ...
      <div className='w-full max-w-lg p-4 bg-white rounded-lg flex flex-col border border-gray-200 min-h-96 '>
        <div className='flex items-center gap-3'>
          <Image className='w-7 h-7 text-[#00AD25]' />
          <h1 className='text-2xl font-semibold'>Generated Image</h1>
          {
            content && (
              <a href={content} download="generated-image.png" target='_blank' rel='noopener noreferrer'>
                <Download className='text-[#00AD25] w-7 h-7 ml-4' />
              </a>
            )
          }
        </div>
